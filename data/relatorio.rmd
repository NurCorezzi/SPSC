...
ggplot(data.frame(cc_tmp), aes(x = x, y = y)) + geom_line(aes(colour = queue)) + xlab('iteration') + ylab('milhões ops/sec') + scale_x_continuous(breaks = round(seq(min(cc_tmp$x), max(cc_tmp$x), by = 1),1))
